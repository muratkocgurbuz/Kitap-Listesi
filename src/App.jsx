...
export default function App() {
  ...
  return (
    <div className="bg-gradient-to-t from-gray-700 via-rose-500 to-orange-400 min-h-screen font-(family-name:Calibri) text-gray-900">
      <div className="container mx-auto p-4 md:p-8">
        <header className="mb-8">
          <h1 className="text-5xl font-extrabold  text-stone-700">
            Mini Kitaplık
          </h1>
        </header>
        <main className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-white p-4 rounded-lg shadow border border-gray-200">
